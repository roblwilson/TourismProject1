...
model_path = os.path.join(os.path.dirname(__file__), "best_tourism_model_v1.joblib")   # complete the code: filename of the trained model saved by train.py (must match the filename you used there)
